                            ...
                            const wxString& name )
{
    ...
    CD_Notebook->AddPage((wxNotebookPage *)CD_Settings, _(Lang[99]) ,false);
    
    CD_Theme=new wxPanel(CD_Notebook,-1,wxPoint(4,22),wxSize(382,234));
    CD_Notebook->AddPage((wxNotebookPage *)CD_Theme,_(Lang[100]),false);
    
    CD_Keywords=new wxPanel(CD_Notebook,-1,wxPoint(4,22),wxSize(382,234));
    CD_Notebook->AddPage((wxNotebookPage *)CD_Keywords,_(Lang[101]),false);
    
    CD_Compiler=new wxPanel(CD_Notebook,-1,wxPoint(4,22),wxSize(382,234));
    CD_Notebook->AddPage((wxNotebookPage *)CD_Compiler,_(Lang[102]),false);
